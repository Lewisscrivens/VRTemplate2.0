...
void ATracedCar::SetSteeringWheelAlpha(float newAlpha)
{
	...
	frontLeftWheelMesh->SetRelativeRotation(FRotator(currentFrontLeftRotation.Pitch, (newAlpha / 100000) * 40.0f, currentFrontLeftRotation.Roll));
	FRotator currentFrontRightRotation = frontRightWheelMesh->GetRelativeRotation();
	frontRightWheelMesh->SetRelativeRotation(FRotator(currentFrontRightRotation.Pitch, (newAlpha / 100000) * 40.0f, currentFrontRightRotation.Roll));
}
